...
const BMILevels = [
  { valueOriginal: 18.5, value: 25, name: 'Underweight', itemStyle: { color: '#98f5ed' } },
  { valueOriginal: 24.9, value: 25, name: 'Normal', itemStyle: { color: '#60cc1d' } },
  { valueOriginal: 29.9, value: 25, name: 'Overweight', itemStyle: { color: '#dede1f' } },
  { valueOriginal: 30, value: 25, name: 'Obese', itemStyle: { color: '#de521f' } },
]
...
const showResult = (newValue) => {
  ...
  newOptions.title.text = 'Your BMI: ' + newValue
  newOptions.title.subtext = levelSelected.label ?? ''
